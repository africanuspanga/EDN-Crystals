...
export function PageHero({
  ...
  return (
    <section
      className={cn(
        "relative flex min-h-[45vh] items-center bg-[#1b294c] pb-24 pt-32 sm:min-h-[50vh] sm:pb-32 sm:pt-40",
        className
      )}
    >
      {image && (
        <>
          <Image
            ...
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#1b294c]/90 via-[#1b294c]/70 to-[#1b294c]/50" />
        </>
      )}
