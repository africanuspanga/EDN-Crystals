      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {industries.map((industry, index) => (
            ...
            >
              <h3 className="text-base font-semibold text-[#07132f]">
                {industry.title}
              </h3>
        ...
        <div className="mt-12 text-center">
          <Link
            href="/industries"
            className="group inline-flex items-center gap-2 rounded-full bg-[#2849a2] px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-[#10265f]"
          >
            View all industries
