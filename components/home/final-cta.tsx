...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden bg-[#1b294c] py-24 sm:py-32 lg:py-40">
      <Image
        ...
        sizes="100vw"
      />
      <div className="absolute inset-0 bg-gradient-to-r from-[#1b294c]/95 via-[#1b294c]/85 to-[#1b294c]/70" />
